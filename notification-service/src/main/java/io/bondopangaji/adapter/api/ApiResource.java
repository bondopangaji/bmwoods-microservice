...
package io.bondopangaji.adapter.api;

import io.bondopangaji.adapter.api.request.SendSupplierNotificationRequest;
...
public record ApiResource(SendSupplierNotificationUseCase sendSupplierNotificationUseCase) {
    ...
    public void sendAndPersist(@RequestBody SendSupplierNotificationRequest sendSupplierNotificationRequest) {
