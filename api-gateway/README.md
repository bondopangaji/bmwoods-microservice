...
<h3 align="center">API Gateway</h3>
  <p align="center">
    API Gateway of BMWoods Microservice
  </p>
</div>
...
<details>
  ...
  <ol>
    <li>
      <a href="#about-api-gateway">About API Gateway</a>
      <ul>
...
A middleware between client and backend services, act as an entry point of requests across internal API.
